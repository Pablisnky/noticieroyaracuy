...
<div class="cont_panel--menu" id="MenuResponsive">
    ...
    <ul class="cont_panel--ul">
        ...
        <!-- AGREGAR PRODUCTO -->
        <li><a class="cont_panel--li" href="{{ route('AgregarProducto', ['id_comerciante' => session('id_comerciante')]) }}" rel="noopener noreferrer">Agregar producto</a></li>
        ...
        <!-- INVENTARIO -->
        <li><a class="cont_panel--li" href="{{ route('PanelProducto', ['id_comerciante' => session('id_comerciante')]) }}" rel="noopener noreferrer">Inventario</a></li> 
