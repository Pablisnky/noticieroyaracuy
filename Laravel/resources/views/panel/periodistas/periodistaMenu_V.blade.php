...
if(session('id_periodista') == 1){  ?>
    ...
    <div class="cont_panel--menu"  id="MenuResponsive">
        ...
        <ul class="cont_panel--ul">
            <li><a class="cont_panel--li" href="{{ route('AgregarNoticia') }}">Agregar noticia</a></li>
            <li><a class="cont_panel--li" href="{{ route('Index') }}" rel="noopener noreferrer">Noticias en portada</a></li>
            <li><a class="cont_panel--li" href="{{ route('NoticiasGenerales') }}" rel="noopener noreferrer">Noticias generales</a></li>
            {{-- <li><a class="cont_panel--li" href="<?php //echo RUTA_URL?>/Panel_C/yaracuyEnVdeo">Yaracuy en video</a></li> --}}
            <li><a class="cont_panel--li" href="{{ route('Efemerides') }}">Efemerides</a></li>
            <li><a class="cont_panel--li" href="{{ route('Agenda') }}">Agenda</a></li>
            {{-- <li><a class="cont_panel--li" href="<?php echo //RUTA_URL?>/Panel_C/obituario">Obituario</a></li> --}}
            <li><a class="cont_panel--li" href="{{ route('Publicidad') }}">Anuncio publicitario</a></li>
